...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var email, _a, users, userError, user, insertError, updateError;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    email = 'hardik@hkrafted.com';
                    return [4 /*yield*/, supabase.auth.admin.listUsers()];
                case 1:
                    _a = _b.sent(), users = _a.data, userError = _a.error;
                    if (userError) {
                    ...
                    console.log("Found user ".concat(email, " with ID ").concat(user.id));
